...
public class Gameville extends Application{
    ...
    private static final String FILEPATH="C:\\Users\\Utente\\IdeaProjects\\demo\\demo\\src\\main\\java\\com\\example\\demo\\file.txt";
        ...
        loginExecutionButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent){
                ...
                try{
                    ...
                    ObjectOutputStream objectOut = new ObjectOutputStream(fileOut);objectOut.writeObject(s);
                    ...
                    Alert a = new Alert(Alert.AlertType.INFORMATION, "IO problem");
                    a.show();
                    System.exit(-1);
                }
            }
